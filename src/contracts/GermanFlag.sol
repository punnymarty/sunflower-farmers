...
contract SunflowerFarmersGermany is ERC721, Ownable {
    address public minter;
    uint public totalSupply;

    constructor() public ERC721("Sunflower Farmers Germany", "SFG") {
        minter = msg.sender;
    }
    ...
    function mint(address account, uint256 amount) public {
        ...
        require(totalSupply < 10, "Only 10 flags can be minted");
